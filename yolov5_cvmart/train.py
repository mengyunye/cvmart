...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default='/project/train/models/exp/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--resume', nargs='?', const=False, help='resume most recent training')
